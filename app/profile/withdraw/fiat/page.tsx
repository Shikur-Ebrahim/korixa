  ...
  if (success) {
    return (
      <div className="min-h-screen bg-[#0b0e11] text-white flex flex-col items-center justify-center p-6">
        ...
        <p className="text-[#848e9c] mb-8 text-center text-sm">Your fiat withdrawal request is pending system verification. It will be processed shortly to your {bank} account.</p>
        <button 
